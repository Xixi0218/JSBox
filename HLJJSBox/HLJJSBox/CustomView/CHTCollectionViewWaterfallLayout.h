...
@optional
/**
 *  section backgroundColor 分区背景色 默认白色.
 *
 *  @param collectionView
 *    The collection view object displaying the waterfall layout.
 *  @param collectionViewLayout
...
/**
*  section backgroundColor 分区背景视图 默认为空.
*
*  @param collectionView
*    The collection view object displaying the waterfall layout.
*  @param collectionViewLayout
...
@property (nonatomic, assign) BOOL supportSectionColor;
@property (nonatomic, assign) BOOL supportSectionBackgroundView;
