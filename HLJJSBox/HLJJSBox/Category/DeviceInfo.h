...
#define kScreenHeight [DeviceInfo screenHeight]
#define kScreenWidth [DeviceInfo screenWidth]
#define kScreenScale [DeviceInfo screenScale]

#define kOnePixelWidth 1./kScreenScale

#define kDifferHeight [DeviceInfo ios67height]

#define CGSizeMax CGSizeMake(CGFLOAT_MAX, CGFLOAT_MAX)

#define IS_IOS7_LATER   [[[UIDevice currentDevice] systemVersion] floatValue] < 8.0f
#define C_IOS7          (IS_IOS7_LATER ? YES : NO)
